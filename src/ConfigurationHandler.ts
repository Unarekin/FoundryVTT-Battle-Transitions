...
export class ConfigurationHandler {
  #mainDialog: Application;
  #addStepDialog: Application | null = null;
  #configurationDialog: Application | null = null;

  #tabName = "battle-transitions";
  #icon: string[] = ["fas", "crossed-swords", "fa-fw", "bt-icon"];

  protected get appId() { return this.#mainDialog.appId; }
  protected get rootElement() { return this.#mainDialog.element; }

  static inject(dialog: Application): ConfigurationHandler { return new ConfigurationHandler(dialog); }
  ...
  constructor(dialog: Application) {
